...
const (
	...
	API_BASE_URL              = "https://wx2.qq.com/cgi-bin/mmwebwx-bin" /* API基准地址 */
	...
	WEB_WX_VERIFY_USER        = API_BASE_URL + "/webwxverifyuser"        /* 添加好友 */

	SYNC_CHECK_URL = "https://webpush.wx2.qq.com/cgi-bin/mmwebwx-bin/synccheck" /* 检查心跳URL */
